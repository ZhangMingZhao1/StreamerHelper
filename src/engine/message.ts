...
export const downloadStream = (stream: StreamInfo) => {
  ...
  const fakeX: any = {
    ...
    'Accept-Language':
      'zh,zh-TW;q=0.9,en-US;q=0.8,en;q=0.7,zh-CN;q=0.6,ru;q=0.5',
  ...
  App.on('close', (code: any) => {
    ...
    setTimeout(() => {
      ...
      getStreamUrl(stream.streamName, stream.liveUrl, stream.streamTags)
        .then((msg) => {
